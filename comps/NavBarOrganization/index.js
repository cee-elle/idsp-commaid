      ...
      <InnerCont>
        <NavCont>
          ...
          <NavCont2>
            ...
            <NavLinksCont>
              <NavLinks
                bgcolor={router.pathname === "/ActivePostsTable" ? "#f2f2f2" : null}
                onClick={() => {
                  //  onPageHighlight();
                  router.push("/ActivePostsTable");
                }}
              >
                <IconHeart src={nav1Src} />
                <LinkText>{nav1Text}</LinkText>
              </NavLinks>
              <NavLinks
              bgcolor={router.pathname === "/VolunteerHoursTable" ? "#f2f2f2" : null}
                onClick={() => {
                  router.push("/VolunteerHoursTable");
                }}
              >
                <Icons src={nav2Src} />
              ...
              <NavLinks
               bgcolor={router.pathname === "/OrganizationProfile" ? "#f2f2f2" : null}
                onClick={() => {
...
NavBarVolunteer.defaultProps = {
  nav1Text: "Your Posts",
  nav2Text: "Your Volunteer's Hours",
  nav3Text: "Account",
  nav1Src: "postLink.svg",
  nav2Src: "./time.svg",
  nav3Src: "./profile.svg",
